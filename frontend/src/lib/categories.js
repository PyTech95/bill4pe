...
export const CATEGORIES = [
  ...
  { key: 'travel',     label: 'Travel',      icon: Plane,           tint: '#E0F2FE', ink: '#0284C7', accent: '#0EA5E9', sub: ['Auto Booking', 'E-Rickshaw Booking', 'Bike Booking', 'Cab Booking', 'Bus Booking', 'Taxi Booking', 'Self Booking', 'Flight', 'Train', 'Toll'] },
