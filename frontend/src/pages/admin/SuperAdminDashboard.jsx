    ...
    <div className="min-h-screen bg-slate-50" data-testid="superadmin-dashboard">
      ...
      <div className="px-5 md:px-10 py-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          <Tab active={tab === 'settings'} onClick={() => setTab('settings')} testId="tab-settings">Settings</Tab>
        </div>
        ...
        {tab === 'overview' && stats && (
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <StatCard icon={IndianRupee} label="Platform revenue" value={fmtMoney(stats.revenue.platform_fees_collected)} sub="Bill fees collected" testId="stat-revenue" />
            </div>
          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl">
            <div className="rounded-2xl bg-white border border-slate-200 p-6" data-testid="bill-fee-settings-card">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">
                    The convenience fee charged to individual users when they generate a
              ...
              <div className="mt-6 grid sm:grid-cols-2 gap-4">
                <div className="rounded-xl border border-slate-200 p-4">
                  <div className="flex items-center gap-2 text-sm font-semibold text-navy">
                    <UserRound className="w-4 h-4 text-slate-400" /> Individual users
                  </div>
                  <div className="relative mt-3">
                    <Input
                      type="number" min="0" max="100" step="0.1"
                      value={feeForm.individual}
                      onChange={(e) => setFeeForm({ ...feeForm, individual: e.target.value })}
                      className="h-12 rounded-xl pr-9 font-mono text-lg"
                      data-testid="fee-individual-input"
                    />
                ...
                <div className="rounded-xl border border-slate-200 p-4 bg-slate-50">
                  ...
                  <p className="text-[11px] text-slate-500 mt-2 leading-snug">
                    ...
                    <b> unlimited</b> bills with <b>no per-bill convenience fee</b>.
                  </p>
                </div>
              </div>
              ...
              <Button
                onClick={saveFees}
                disabled={savingFees}
                className="press-down mt-6 h-12 px-6 bg-brand text-white hover:bg-[#1858CC] rounded-full font-semibold"
                data-testid="save-bill-fees-btn"
              >
