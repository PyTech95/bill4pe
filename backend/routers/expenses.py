...
async def create_expense(body: ExpenseCreate, user=Depends(get_current_user)):
    ...
    # Corporate employees are on the company's monthly subscription — bills are
    # generated DIRECTLY and UNLIMITED, with NO convenience fee and no company
    # wallet dependency (unlike individual users).
    if is_employee:
